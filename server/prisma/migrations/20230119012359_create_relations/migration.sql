...
CREATE TABLE "new_days_habits" (
    ...
    CONSTRAINT "days_habits_habits_id_fkey" FOREIGN KEY ("habits_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_days_habits" ("day_id", "habits_id", "id") SELECT "day_id", "habits_id", "id" FROM "days_habits";
DROP TABLE "days_habits";
ALTER TABLE "new_days_habits" RENAME TO "days_habits";
CREATE UNIQUE INDEX "days_habits_day_id_habits_id_key" ON "days_habits"("day_id", "habits_id");
